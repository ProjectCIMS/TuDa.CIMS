...
namespace TuDa.CIMS.Api.Migrations
{
    ...
    [Migration("20250208212834_AddPredecessorandSucessorToPurchase")]
    partial class AddPredecessorandSucessorToPurchase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TuDa.CIMS.Shared.Entities.Purchase", b =>
                {
                    ...
                    b.HasOne("TuDa.CIMS.Shared.Entities.Purchase", "Successor")
                        .WithOne("Predecessor")
                        .HasForeignKey("TuDa.CIMS.Shared.Entities.Purchase", "SuccessorId")
