...
public interface IPurchaseApi
{
    ...
    /// </returns>
    public async Task<ErrorOr<Guid>> CreateAsync(CreatePurchaseDto item) =>
        await CreateAsyncInternal(item).ToErrorOrAsync();
    ...
    /// <remarks>This will be generated by <see cref="Refit"/>.</remarks>
    [Post("/{workingGroupId}")]
    protected Task<IApiResponse<Guid>> CreateAsyncInternal([Body] CreatePurchaseDto item);
