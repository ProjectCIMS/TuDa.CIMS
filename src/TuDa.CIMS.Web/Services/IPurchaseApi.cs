...
public interface IPurchaseApi
{
    ...
    /// </returns>
    public async Task<ErrorOr<Purchase>> GetAsync(Guid id, Guid workingGroupId) =>
        await GetAsyncInternal(id, workingGroupId).ToErrorOrAsync();
    ...
    /// </returns>
    public async Task<ErrorOr<Guid>> CreateAsync(CreatePurchaseDto createPurchaseDto) =>
        await CreateAsyncInternal(createPurchaseDto).ToErrorOrAsync();
    ...
    /// <remarks>This will be generated by <see cref="Refit"/>.</remarks>
    [Post("/{workingGroupId}")]
    protected Task<IApiResponse<Guid>> CreateAsyncInternal([Body] CreatePurchaseDto createPurchaseDto);
    ...
    public async Task<ErrorOr<Deleted>> RemoveAsync(Guid id, Guid workingGroupId) =>
        await RemoveAsyncInternal(id, workingGroupId).ToErrorOrAsync<Deleted>();
