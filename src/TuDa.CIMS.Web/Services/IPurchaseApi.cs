...
public interface IPurchaseApi
{
    ...
    [Get("/{workingGroupId}/purchases/{id}")]
    ...
    [Post("/{workingGroupId}/purchases/")]
    protected Task<IApiResponse<Purchase>> CreateAsyncInternal(Guid workingGroupId, [Body] CreatePurchaseDto createPurchaseDto);
    ...
    /// </returns>
    /// <remarks>This will be generated by <see cref="Refit"/>.</remarks>
    [Delete("/{workingGroupId}/purchases/{id}")]
