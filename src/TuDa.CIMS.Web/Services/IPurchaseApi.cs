...
public interface IPurchaseApi
{
    ...
    /// <summary>
    /// Retrieves the signature of a purchase.
    /// </summary>
    /// <param name="workingGroupId">The unique identifier of the working group.</param>
    /// <param name="purchaseId">The unique identifier of the purchase.</param>
    /// <returns>
    /// A <see cref="Task"/> representing the asynchronous operation,
    /// returning an <see cref="ErrorOr{T}"/> containing the signature as a Base64 string
    /// or an error if the purchase is not found.
    /// </returns>
    ...
    /// <returns>
    /// A <see cref="Task"/> representing the asynchronous operation,
    /// returning an <see cref="IApiResponse{T}"/> containing the signature as a byte array.
    /// </returns>
    /// <remarks>This will be generated by <see cref="Refit"/>.</remarks>
    [Get($"/{{{nameof(workingGroupId)}}}/purchases/{{{nameof(purchaseId)}:guid}}/signature")]
    protected Task<IApiResponse<string>> RetrieveSignatureAsyncInternal(
        Guid workingGroupId,
        Guid purchaseId
    );
}
