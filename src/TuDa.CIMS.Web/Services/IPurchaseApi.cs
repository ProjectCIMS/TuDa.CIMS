...
public interface IPurchaseApi
{
    ...
    /// </returns>
    public async Task<ErrorOr<Guid>> CreateAsync(Purchase item) =>
        await CreateAsyncInternal(item.ToString()).ToErrorOrAsync();
    ...
    public async Task<ErrorOr<Updated>> UpdateAsync(Guid id, UpdatePurchaseDto updatePurchaseDto) =>
        await UpdateAsyncInternal(id, updatePurchaseDto.ToString()).ToErrorOrAsync();
