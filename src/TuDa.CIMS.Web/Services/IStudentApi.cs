...
public interface IStudentApi
{
    ...
    ) => await AddAsyncInternal(workingGroupId, createModel).ToErrorOrAsync<Student>();
    ...
    protected Task<IApiResponse<Student>> AddAsyncInternal(
        Guid workingGroupId,
        CreateStudentDto createModel
    );
    ...
    ) => await UpdateAsyncInternal(workingGroupId, id, updateModel).ToErrorOrAsync<Updated>();
    ...
    protected Task<IApiResponse> UpdateAsyncInternal(
        Guid workingGroupId,
        Guid id,
        UpdateStudentDto updateModel
    );
